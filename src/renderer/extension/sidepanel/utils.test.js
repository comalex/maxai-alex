...
const {
  ...
  replaceStringWithInfluencerName
} = require("./utils");
...
describe("convertHistoryToString", () => {
  ...
  it("should add 'usr: <blank>' if the first item in history is not from user", () => {
    const history = [
      {
        role: "influencer",
        content: "Hello John Doe, how can I assist you today?"
      },
      { role: "user", content: "I need help with my account " },
    ...
    const history = [
      {
        role: "influencer",
        content:
          "Woooooooow 😲😲 Thank you for coming to my page, honey! It's so good to see you here 😘 Tell me where are you from? Also I wanna say that you won't be bored with me, I'll win your heart😏 You can unlock that bundle and see whats hidden there🤭 How are you doing and in the mood after you see it?"
      }
    ];
    const model = "LagrandAI";
    const usernames = [""];
  ...
  it("should replace all variations of the model name with the given name", () => {
    ...
    const inputString =
      "Hi Gemma Massey, how are you? Gemma Massey is here. Miss Massey is present. Gem is short for Gemma.";
    const expectedOutput =
      "Hi Jane, how are you? Jane is here. Miss Jane is present. Jane is short for Jane.";
  ...
  it("should not replace any part of the string if no variations of the model name are found", () => {
    ...
    const selectedModel = {
      influencer_character: "Jane",
      influencer_character_last_name: "Doe"
    };
    const inputString =
      "Hi Jane, how are you? Jane is here. Miss Jane is present. Jane is short for Jane.";
    const expectedOutput =
      "Hi Gemma, how are you? Gemma is here. Miss Gemma is present. Gemma is short for Gemma.";

    const result = replaceStringWithInfluencerName(
      account,
      selectedModel,
      inputString
    );
  ...
  it("should not replace any part of the string if no variations of the model name are found", () => {
    ...
    const selectedModel = {
      influencer_character: "Legrand",
      influencer_character_last_name: "Wolf"
    };
    const inputString =
      "Well, I'm Legrand, AKA The Wolf. I'm 45 years old and I'm a porn star and sexual omnivore. I'm usually a top, but I'm open minded and love to try new things.";
    const expectedOutput =
      "Well, I'm Legrand, AKA The Wolf. I'm 45 years old and I'm a porn star and sexual omnivore. I'm usually a top, but I'm open minded and love to try new things.";
  ...
  it("should convert history to string correctly with real names", () => {
    ...
    expect(() =>
      convertHistoryToString(history, model, usernames)
    ).not.toThrow();
  });
});
